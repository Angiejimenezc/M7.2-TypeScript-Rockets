...
let createRocket_1: any = document.querySelector("#createRocket1");
let infoRocket_1: any = document.querySelector("#printRocket1");
let acelerateRocket_1: any = document.querySelector("#accelRocket1");
let brakeRocket_1: any = document.querySelector("#breakRocket1");

let createRocket_2: any = document.querySelector("#createRocket2");
let infoRocket_2: any = document.querySelector("#printRocket2");
let acelerateRocket_2: any = document.querySelector("#accelRocket2");
let brakeRocket_2: any = document.querySelector("#breakRocket2");
