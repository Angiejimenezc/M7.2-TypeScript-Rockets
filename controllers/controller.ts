...
function crearCohete(n:number){
    if(n == 1){
        ...
        (<HTMLInputElement>document.getElementById("velocidad1")).innerText = `Cohete preparado, Comenzamos?` ;
        (<HTMLInputElement>document.getElementById("cohete1")).style.visibility = "visible";
        animateCSS('.cohete_1', 'flip');
        (<HTMLInputElement>document.getElementById("cohete1Crear")).innerText = `${cohete1.codigo} con *${propulsores1.length}* propulsores`;
        ...
        (<HTMLInputElement>document.getElementById("velocidad2")).innerText = 'Cohete preparado, Comenzamos?';
        (<HTMLInputElement>document.getElementById("cohete2")).style.visibility = "visible";
        animateCSS('.cohete_2', 'flip');
        (<HTMLInputElement>document.getElementById("cohete2Crear")).innerText = ` ${cohete2.codigo} con *${propulsores2.length}* propulsores`;
...
function acelerarCohete(n:number){
    if(n == 1){
        if(cohete1 == undefined){
            (<HTMLInputElement>document.getElementById("cohete1Error")).innerText = `Aún no has creado el Cohete`
        }else{
            acelerar(cohete1);
            calcularVelocidad(cohete1);
            (<HTMLInputElement>document.getElementById("velocidad1")).innerText = `Velocidad actual del Cohete es: ${potencia_total}`;
            animateCSS('.cohete_1', 'backOutUp');
            console.log(cohete1);
        }
    }else if (n == 2){
        if(cohete2 == undefined){
            (<HTMLInputElement>document.getElementById("cohete2Error")).innerText = `Aún no has creado el Cohete`
        }else{
            acelerar(cohete2)
            calcularVelocidad(cohete2);
            (<HTMLInputElement>document.getElementById("velocidad2")).innerText = `Velocidad actual del Cohete es: ${potencia_total}`;
...
function mostrarCohete(n:number){
    if(n == 1){
        if(cohete1 == undefined){
            ...
            (<HTMLInputElement>document.getElementById("cohete1Mostrar")).innerText = `Los propulsores son : ${propImpr}`;
        ...
        if(cohete2 == undefined){
            ...
            (<HTMLInputElement>document.getElementById("cohete2Mostrar")).innerText = `Los propulsores son : ${propImpr}`;
